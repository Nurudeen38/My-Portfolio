export const articles = [
 {
    "id": "scalable-react-applications-with-vite",
...
type BankingApiClient = {
    [K in keyof typeof bankingRoutes]: {
        [M in typeof bankingRoutes[K]['methods'][number]]: 
            ...
            <p>Implementing these patterns in our Banque Misr migration resulted in:</p>
            <ul>
